...
const SkillDefinition& GetSkillDefinition(SkillId id) {
    static const SkillDefinition shieldBash{"Shield Bash", "Melee hit and weakens one enemy attack for 2 turns.", {{SkillEffectType::DirectDamage, 14, 0}, {SkillEffectType::EnemyAttackDebuff, 4, 2}}};
    static const SkillDefinition fortressStance{"Fortress Stance", "Gain heavy damage reduction for 2 turns.", {{SkillEffectType::PlayerDamageReductionBuff, 6, 2}}};
    static const SkillDefinition shockwave{"Shockwave", "Ground slam hitting all enemies.", {{SkillEffectType::AreaDamage, 10, 0}}};
    static const SkillDefinition crushingTaunt{"Crushing Taunt", "Strike one enemy and apply a short attack debuff.", {{SkillEffectType::DirectDamage, 11, 0}, {SkillEffectType::EnemyAttackDebuff, 3, 1}}};

    static const SkillDefinition whirlwind{"Whirlwind", "Spin attack that hits all enemies.", {{SkillEffectType::AreaDamage, 15, 0}}};
    static const SkillDefinition sunderStrike{"Sunder Strike", "Heavy strike and bleeding over time.", {{SkillEffectType::DirectDamage, 12, 0}, {SkillEffectType::DamageOverTime, 7, 2}}};
    static const SkillDefinition valiantGuard{"Valiant Guard", "Block incoming damage for 2 turns.", {{SkillEffectType::PlayerDamageReductionBuff, 4, 2}}};
    static const SkillDefinition lanceRush{"Lance Rush", "Piercing hit with additional chip damage over time.", {{SkillEffectType::DirectDamage, 16, 0}, {SkillEffectType::DamageOverTime, 4, 2}}};

    static const SkillDefinition poisonedBlades{"Poisoned Blades", "Single-target strike with poison over time.", {{SkillEffectType::DirectDamage, 10, 0}, {SkillEffectType::DamageOverTime, 9, 3}}};
    static const SkillDefinition shadowFlurry{"Shadow Flurry", "Fast area assault that weakens enemies.", {{SkillEffectType::AreaDamage, 12, 0}, {SkillEffectType::EnemyAttackDebuff, 3, 1}}};
    static const SkillDefinition venomCloud{"Venom Cloud", "Poisons all enemies for multiple turns.", {{SkillEffectType::DamageOverTime, 7, 3}}};
    static const SkillDefinition evasionFocus{"Evasion Focus", "Reduce incoming damage while attacking.", {{SkillEffectType::PlayerDamageReductionBuff, 4, 2}, {SkillEffectType::DirectDamage, 8, 0}}};

    static const SkillDefinition firestorm{"Firestorm", "Fire burst on all enemies plus burn over time.", {{SkillEffectType::AreaDamage, 13, 0}, {SkillEffectType::DamageOverTime, 6, 2}}};
    static const SkillDefinition arcaneBarrier{"Arcane Barrier", "Magic shield and a focused bolt.", {{SkillEffectType::PlayerDamageReductionBuff, 5, 2}, {SkillEffectType::DirectDamage, 11, 0}}};
    static const SkillDefinition chainLightning{"Chain Lightning", "High area burst damage.", {{SkillEffectType::AreaDamage, 16, 0}}};
    static const SkillDefinition frostHex{"Frost Hex", "Single spell that lowers enemy attack for 2 turns.", {{SkillEffectType::DirectDamage, 9, 0}, {SkillEffectType::EnemyAttackDebuff, 5, 2}}};

    static const SkillDefinition purifyingLight{"Purifying Light", "Heal yourself and smite one enemy.", {{SkillEffectType::SelfHeal, 20, 0}, {SkillEffectType::DirectDamage, 9, 0}}};
    static const SkillDefinition weakeningPrayer{"Weakening Prayer", "Soft area damage and enemy attack debuff.", {{SkillEffectType::AreaDamage, 8, 0}, {SkillEffectType::EnemyAttackDebuff, 4, 2}}};
    static const SkillDefinition renew{"Renew", "Strong self-heal and small defense buff.", {{SkillEffectType::SelfHeal, 24, 0}, {SkillEffectType::PlayerDamageReductionBuff, 3, 1}}};
    static const SkillDefinition sacredWave{"Sacred Wave", "Holy wave against all enemies.", {{SkillEffectType::AreaDamage, 12, 0}}};

    static const SkillDefinition acidBomb{"Acid Bomb", "Area explosion with acid damage over time.", {{SkillEffectType::AreaDamage, 11, 0}, {SkillEffectType::DamageOverTime, 8, 2}}};
    static const SkillDefinition toxicMist{"Toxic Mist", "Poison cloud that lowers enemy attack.", {{SkillEffectType::DamageOverTime, 7, 2}, {SkillEffectType::EnemyAttackDebuff, 4, 2}}};
    static const SkillDefinition volatileFlask{"Volatile Flask", "Strong direct blast to one enemy.", {{SkillEffectType::DirectDamage, 18, 0}}};
    static const SkillDefinition catalystSerum{"Catalyst Serum", "Enhance survivability and recover health.", {{SkillEffectType::PlayerDamageReductionBuff, 5, 2}, {SkillEffectType::SelfHeal, 14, 0}}};
